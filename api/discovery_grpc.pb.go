...
func (c *discoveryServiceClient) StreamResources(ctx context.Context, opts ...grpc.CallOption) (DiscoveryService_StreamResourcesClient, error) {
	stream, err := c.cc.NewStream(ctx, &DiscoveryService_ServiceDesc.Streams[0], "/grape.api.DiscoveryService/StreamResources", opts...)
	if err != nil {
		return nil, err
	}
...
var DiscoveryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grape.api.DiscoveryService",
	...
	Metadata: "grape/api/discovery.proto",
}
