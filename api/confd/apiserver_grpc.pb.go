...
type ApiServerClient interface {
	Set(ctx context.Context, in *Configs, opts ...grpc.CallOption) (*core.Empty, error)
	Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Configs, error)
...
func (c *apiServerClient) Set(ctx context.Context, in *Configs, opts ...grpc.CallOption) (*core.Empty, error) {
	out := new(core.Empty)
	err := c.cc.Invoke(ctx, "/grape.api.confd.ApiServer/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServerClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Configs, error) {
	out := new(Configs)
	err := c.cc.Invoke(ctx, "/grape.api.confd.ApiServer/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServerClient) Del(ctx context.Context, in *DelRequest, opts ...grpc.CallOption) (*core.Empty, error) {
	out := new(core.Empty)
	err := c.cc.Invoke(ctx, "/grape.api.confd.ApiServer/Del", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiServerServer interface {
	Set(context.Context, *Configs) (*core.Empty, error)
	Get(context.Context, *GetRequest) (*Configs, error)
...
func (UnimplementedApiServerServer) Set(context.Context, *Configs) (*core.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Set not implemented")
}
func (UnimplementedApiServerServer) Get(context.Context, *GetRequest) (*Configs, error) {
...
func _ApiServer_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grape.api.confd.ApiServer/Set",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServerServer).Set(ctx, req.(*Configs))
	}
...
func _ApiServer_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grape.api.confd.ApiServer/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiServer_Del_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grape.api.confd.ApiServer/Del",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ApiServer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grape.api.confd.ApiServer",
	...
	Metadata: "grape/api/confd/apiserver.proto",
}
